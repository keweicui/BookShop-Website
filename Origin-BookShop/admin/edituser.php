...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="20" bgcolor="#FFCF60"><div align="center" class="style1">ID Management</div></td>
  </tr>
  <tr>
    <td  bgcolor="#666666"><table width="600" border="0" align="center" cellpadding="0" cellspacing="1">
	   ...
	   ?>
	   <tr>
          <td width="224" height="20" bgcolor="#FFFFFF"><div align="center">ID Name</div></td>
          <td width="93" bgcolor="#FFFFFF"><div align="center">Status</div></td>
          <td width="79" bgcolor="#FFFFFF"><div align="center">Delete</div></td>
          <td width="75" bgcolor="#FFFFFF"><div align="center">Check</div></td>
...
<table width="600" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<?php echo $page;?>&nbsp;Page/Total&nbsp;<?php echo $pagecount; ?>
        <?php
		  if($page>=2)
		  {
		  ?>
        <a href="edituser.php?page=1" title="First Page"><font face="webdings"> 9 </font></a> 
		<a href="edituser.php?page=<?php echo $page-1;?>" title="ǰһҳ"><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
    ...
    <td width="92"><div align="center"><input type="submit" value="Delete Selected" class="buttoncss">
    </div></td>
  </tr>
