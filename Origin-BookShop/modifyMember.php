        ...
        <div id="t3-content" class="t3-content col-xs-12">
            ...
            <div class="registration col-sm-6 col-sm-offset-3">
                ...
                <form id="member-registration" action="modifyMember_deal.php"  onsubmit="return regis();"
                    ...
                    <fieldset>
                        <legend style="color:#0885B1;font-size: 31px">Information change</legend>
                    ...
                    <div class="form-actions clearfix">
                        ...
                        <button type="button" onClick="javascript:history.go(-1)" class="btn btn-primary pull-left">Conceal</button>
                   </div>
                </form>
            </div>
