...
<?php
	   ...
	   if($total==0)//如果查询结果为空
	   {
	     echo "has not been commented!";//输出字符串
	   }
	   else
	   {
 ...
 <form name="form2" method="post" action="deletepingjia.php"> 
  ...
  <tr>
    <td height="40" colspan="2" bgcolor="#666666"><table width="750" height="45" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="294" height="22" bgcolor="#FFFFFF"><div align="center">Topic</div></td>
        <td width="93" bgcolor="#FFFFFF"><div align="center">Nmae</div></td>
        <td width="100" bgcolor="#FFFFFF"><div align="center">User</div></td>
        <td width="110" bgcolor="#FFFFFF"><div align="center">Date</div></td>
        <td width="87" bgcolor="#FFFFFF"><div align="center">Check</div></td>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center"><a href="javascript:openpj(<?php echo $info1['id'];?>);">Check</a></div></td>
  ...
  <tr>
	...
	<div align="left">
	Page/Total&nbsp;<?php echo $pagecount; ?>&nbsp;
        <?php
		  if($page>=2)//如果当前页数大于等于2
		  {
		  ?>
        <a href="editpinglun.php?page=1" title="首页"><font face="webdings"> 9 </font></a> 
		<a href="editpinglun.php?page=<?php echo $page-1;?>" title="Pre Page"><font face="webdings"> 7 </font></a>
        <?php
		  }
    ...
    <td width="93"><div align="center"><input type="submit" value="Delete selected" class="buttoncss"></div></td>
  </tr>
  </form>
</table>
